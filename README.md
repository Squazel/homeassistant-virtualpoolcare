...
sensor:
  - platform: virtualpoolcare
    ...
    api_timeout_seconds: 30               # Optional: API timeout in seconds (default: 20)
```
...
| api_timeout_seconds | number | 20 | No | Timeout for API calls in seconds (increase if seeing timeout errors) |
